        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Buys</div>
                    <div class="panel-body">
                        <a href="{{ url('/buys/create') }}" class="btn btn-success btn-sm" title="Add New Buy">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/buys', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        <div class="input-group">
                            <input type="text" class="form-control" name="search" placeholder="Search...">
                            <span class="input-group-btn">
                                <button class="btn btn-default " type="submit">OK
                                ...
                                @foreach($buys as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- <a href="{{ url('/buys/' . $item->id . '/edit') }}" title="Edit Buy"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> --}}
                                            {!! Form::open([
                                                'method'=>'DELETE',
                                                'url' => ['/buys', $item->id],
